    ...
    <footer className="bg-gradient-to-br from-gray-900 via-orange-900 to-gray-900 text-white mt-auto relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 py-12 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          {/* Customer Service */}
          <div>
            <h4 className="font-bold text-lg mb-4 text-amber-300">
              Customer Service
            </h4>
            <ul className="space-y-3 text-sm">
              <li>
          ...
          <div>
            ...
            <p className="text-gray-300 text-sm mb-4">
              Stay connected for updates & deals! 💌
            </p>
            <div className="flex space-x-4">
              <a
                ...
                className="w-10 h-10 bg-white/10 backdrop-blur-sm rounded-full flex items-center justify-center text-gray-300 hover:text-white hover:bg-gradient-to-r hover:from-orange-500 hover:to-amber-500 transition-all duration-300 transform hover:scale-110 hover:-translate-y-1"
              >
                <svg
                  className="w-5 h-5"
                  fill="currentColor"
